...
import {Image, Card, Container, Grid, Header, Divider, Segment} from 'semantic-ui-react'
import {ResContainer} from './Globals'
import msu from '../images/msu.png'

const studentDesc = <span>Currently attending <i className="MSU">Michigan State University</i> as a Senior.</span>
